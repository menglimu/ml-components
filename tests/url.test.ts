...
test("url 取值", () => {
  expect(new BestURL("aa.aa.com?aa=1").getParams("aa")).toBe("1");
  expect(new BestURL("aa.aa.com#/a?aa=1&").getParams("aa")).toBe("1");
  expect(new BestURL("aa.aa.com#?aa=1&aa=2&?aa").getParams("aa")).toBe("1");
  expect(new BestURL("aa.aa.com#?aa=1&aa=2&?aa=1#?B=1").getParams("B")).toBe("1");
...
test("url 修改值", () => {
  expect(new BestURL("aa.aa.com?aa=1#11").setParams("aa", 11)).toBe("aa.aa.com?aa=11#11");
